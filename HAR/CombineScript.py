...
train_path = r"HAR\human+activity+recognition+using+smartphones\UCI HAR Dataset\UCI HAR Dataset\train"
test_path = r"HAR\human+activity+recognition+using+smartphones\UCI HAR Dataset\UCI HAR Dataset\test"
